...
namespace WebApplicationMD4.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(AspdatabaseContext context)
        {
            _context = context;
        }
        ...
        {
            var aspdatabaseContext = _context.Courses.Include(c => c.Teacher);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (course != null)
            {
                ...
                var assignments = _context.Assignments.Where(s => s.AssignmentId == id);    
